...
comparison.to_csv('winning_predictions_svm.csv', index=False)

print("\nComparison of Predicted vs Actual Winners with Probabilities saved to 'winning_predictions_svm.csv':")
